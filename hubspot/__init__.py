...
def hubspot(
    ...
    @dlt.resource(name="companies", write_disposition={"disposition": "merge", "strategy": "scd2"})
    def companies(
        api_key: str = api_key,
    ...
    @dlt.resource(name="auctions", write_disposition="replace")
    def auctions(
        api_key: str = api_key,
        include_history: bool = include_history,
        props: Sequence[str] = DEFAULT_CONTACT_PROPS,
    ...
    return companies, contacts, auctions
...
def crm_objects(
    ...
    print(f"properties for object type {object_type}")
    print(props)
